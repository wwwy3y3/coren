...
var randomFromSeed = __webpack_require__(39);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_coren_lib_client_collectorHoc__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_coren_lib_client_collectorHoc___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_coren_lib_client_collectorHoc__);
var _dec, _class;




let Root = (_dec = __WEBPACK_IMPORTED_MODULE_1_coren_lib_client_collectorHoc___default()(), _dec(_class = class Root extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
  static defineHead() {
    return {
      title: "home",
...
exports['default'] = function () {
  return function (WrappedComponent) {
    ...
    _componentHook2['default'].componentDidImport(uniqId, WrappedComponent);
    ...
    var Hoc = function (_React$Component) {
      ...
      function Hoc(props) {
        ...
        _componentHook2['default'].componentDidConstruct(uniqId, WrappedComponent, props);
        return _this;
      }
    ...
    return (0, _hoistNonReactStatics2['default'])(Hoc, WrappedComponent);
  };
};
...
var _componentHook = __webpack_require__(36);

var _componentHook2 = _interopRequireDefault(_componentHook);
...
var Hook = function () {
  ...
  _createClass(Hook, [{
    key: "componentDidImport",
    value: function () {
      function componentDidImport(id, component) {
        if (this.didImportCallback) {
          this.didImportCallback(id, component);
        }
      }

      return componentDidImport;
    }()
  }, {
    key: "bindComponentDidImport",
    value: function () {
      function bindComponentDidImport(fn) {
        this.didImportCallback = fn;
      }

      return bindComponentDidImport;
    }()
  }, {
    key: "componentDidConstruct",
    value: function () {
      function componentDidConstruct(id, component, props) {
        if (this.didConstructCallback) {
          this.didConstructCallback(id, component, props);
        }
      }

      return componentDidConstruct;
    }()
  }, {
    key: "bindComponentDidConstruct",
    value: function () {
      function bindComponentDidConstruct(fn) {
        this.didConstructCallback = fn;
      }

      return bindComponentDidConstruct;
    }()
  }]);
